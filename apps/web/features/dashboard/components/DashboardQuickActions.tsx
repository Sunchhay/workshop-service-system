...
import { ClipboardList, CreditCard, Package, ShoppingCart, Users } from 'lucide-react';

import { useTranslation } from '@/lib/i18n/TranslationContext';

const actions = [
  { labelKey: 'dashboard.newServiceJob', href: '/admin/service-jobs/create', icon: ClipboardList, color: 'bg-blue-500/10 text-blue-600 dark:text-blue-400' },
  ...
  { labelKey: 'dashboard.newCart', href: '/admin/carts', icon: ShoppingCart, color: 'bg-purple-500/10 text-purple-600 dark:text-purple-400' },
